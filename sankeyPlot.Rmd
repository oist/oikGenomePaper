...
colnames(circ_mat) <- c("N chr X", "N PA", "N LG2", "N LG1", "N chr Y", "N other a", "N other b", "N other c", "N other d", "N other e", "N other f", "none") #1-7
LG_names <- c("X", "PA", "LG2", "LG1", "Y", "UnA", "UnB", "UnC", "UnD", "UnE", "UnF")
...
chr_names <- c("chr X", "PAR", "chr 2", "chr 1", "chr Y", "N chr X", "N PAR", "N LG2", "N LG1", "N chr Y", "N Un a", "N Un b", "N Un c", "N Un d", "N Un e", "N Un f")

# link groups


# create node group
node_group <- c("chr X", "PA", "chr 2", "chr 1", "chr Y", "chr X", "PA", "chr 2", "chr 1", "chr Y", "chr 2", "PA", "other", "chr 1", "chr Y", "chr 2")
